...
Once the signal is sent, the AIVa robot receives it through its Left, Center, and Right (LCR) sensors. These sensors continuously collect directional and environmental data. The incoming signal is analyzed to determine the relative position of the patient.
